...
Covered (79 rows, `sigma-manifest.tsv`): the Windows-security and Sysmon corpus across
...
can only infer, the full ransomware chain (recovery-inhibition, service-stop burst,
...
runner reports the count (`79/79 passed (36 with a true-negative)`), and rules that grow a
